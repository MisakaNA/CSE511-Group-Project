...
object SparkSQLExample {
  ...
  def ST_Contains(pointString: String, queryRectangle: String): Boolean = {
    ...
    val rectX1 = math.min(valueArray(0).asInstanceOf[Double], valueArray(2).asInstanceOf[Double])
    val rectY1 = math.min(valueArray(1).asInstanceOf[Double], valueArray(3).asInstanceOf[Double])
    val rectX2 = math.max(valueArray(0).asInstanceOf[Double], valueArray(2).asInstanceOf[Double])
    val rectY2 = math.min(valueArray(1).asInstanceOf[Double], valueArray(3).asInstanceOf[Double])
